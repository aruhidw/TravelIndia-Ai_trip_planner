...
const fallbackDestinations = {
  ...
  delhi: {
    ...
    state: "Delhi",
    overview:
      "Delhi, India's capital, is a vibrant mix of ancient history and modernity with Mughal architecture, British-era buildings, and bustling markets.",
    ...
    hotels: [
      ...
      {
        name: "Mid-range Hotel, Karol Bagh",
        priceRange: "₹2000-3500",
        rating: 4.2,
      },
      {
        name: "Luxury Hotel, Connaught Place",
    ...
    reach:
      "Well connected by flights (IGI Airport), trains (New Delhi, Old Delhi stations), and buses",
    estimatedCost:
      "₹6000-9000 for 3 days (budget), ₹10000-15001 (mid-range), ₹15001+ (luxury)",
    weather:
      "Extreme summers (April-June: 25-45°C), Pleasant winters (Nov-Feb: 8-22°C), Monsoon: July-Sept",
    safety:
      "Be cautious in crowded areas. Use registered taxis. Emergency: 112",
    carry: [
      "Comfortable shoes",
      "Water bottle",
      "ID proof",
  ...
  jaipur: {
    ...
    state: "Rajasthan",
    overview:
      "Jaipur, the Pink City, is Rajasthan's capital with magnificent forts, palaces, and rich Rajput heritage.",
    ...
    hotels: [
      ...
      { name: "Palace Hotel", priceRange: "₹3000-5001", rating: 4.4 },
    ...
    reach:
      "Flight to Jaipur International, train to Jaipur Junction, buses from major cities",
  ...
  agra: {
    ...
    state: "Uttar Pradesh",
    overview:
      "Home to the iconic Taj Mahal, Agra is a UNESCO World Heritage city with Mughal architectural marvels.",
    ...
    hotels: [
      ...
      { name: "Luxury Hotel", priceRange: "₹5001-8000", rating: 4.5 },
    ],
    food: [
      "Petha (sweet)",
      "Mughlai Cuisine",
    ...
    reach:
      "Train to Agra Cantt, flight to Delhi (200km away), buses from Delhi",
    estimatedCost: "₹5001-8000 for 2 days",
  ...
  manali: {
    ...
    overview:
      "Himalayan hill station with snow-capped peaks, adventure sports, and serene landscapes.",
    ...
    hotels: [
      ...
      { name: "Luxury Stay", priceRange: "₹5001-8000", rating: 4.5 },
    ],
    food: [
      "Siddu",
      "Thenthuk",
    ...
    safety:
      "Altitude acclimatization important. Adventure sports with certified operators.",
  ...
  shimla: {
    ...
    state: "Himachal Pradesh",
    overview:
      "Queen of Hills with colonial charm, scenic views, and pleasant climate.",
    ...
    hotels: [
      ...
      { name: "Wildflower Hall", priceRange: "₹8000-15001", rating: 4.7 },
    ],
    ...
    reach:
      "Kalka-Shimla Toy Train, flight to Chandigarh (120km), buses from Delhi",
    estimatedCost: "₹5001-8000 for 3 days",
  ...
  goa: {
    ...
    state: "Goa",
    overview:
      "India's beach paradise with Portuguese heritage, stunning beaches, and vibrant nightlife.",
    ...
    hotels: [
      ...
      { name: "Luxury Resort", priceRange: "₹5001-8000", rating: 4.5 },
    ],
    food: [
      "Fish Curry Rice",
      "Pork Vindaloo",
    ...
    reach:
      "Direct flights to Goa International, trains via Konkan Railway, overnight buses",
  ...
  kerala: {
    ...
    state: "Kerala",
    overview:
      "God's Own Country with backwaters, beaches, hill stations, and rich cultural heritage.",
    ...
    hotels: [
      {
        ...
        priceRange: "₹4000-8000 per day",
        rating: 4.4,
      },
      { name: "Hill Resort, Munnar", priceRange: "₹2500-5001", rating: 4.3 },
    ...
    reach:
      "Flights to Kochi, Thiruvananthapuram, or Kozhikode. Trains to major stations",
    estimatedCost: "₹10000-15001 for 5 days",
    weather: "Tropical. Monsoon: June-August, Winter: 22-32°C",
    safety:
      "Monsoon season can have heavy rains. Check weather before backwater trips.",
    carry: [
  ...
  bangalore: {
    ...
    state: "Karnataka",
    overview:
      "Garden City and India's IT capital with pleasant climate, parks, and vibrant nightlife.",
    ...
    hotels: [
      ...
      { name: "Business Hotel", priceRange: "₹3000-5001", rating: 4.3 },
      { name: "Luxury Hotel", priceRange: "₹5001-8000", rating: 4.6 },
    ],
    food: [
      "Masala Dosa",
      "Bisi Bele Bath",
    ...
    reach:
      "Flights to Kempegowda Airport, trains to Bangalore City, buses from all cities",
    estimatedCost: "₹7000-10000 for 3 days",
  ...
  chennai: {
    ...
    state: "Tamil Nadu",
    overview:
      "Cultural capital of Tamil Nadu with beaches, temples, and delicious South Indian cuisine.",
  ...
  hyderabad: {
    ...
    state: "Telangana",
    overview:
      "City of Pearls and Biryani with historic monuments and modern IT hubs.",
    ...
    reach:
      "Flights to Hyderabad International, trains to Secunderabad/Hyderabad, buses",
    estimatedCost: "₹6000-9000 for 3 days",
  ...
  darjeeling: {
    ...
    state: "West Bengal",
    overview:
      "Queen of the Himalayas with tea gardens, toy train, and stunning mountain views.",
    ...
    hotels: [
      ...
      { name: "Hill Resort", priceRange: "₹3000-5001", rating: 4.4 },
      { name: "Luxury Stay", priceRange: "₹5001-8000", rating: 4.6 },
    ],
    ...
    reach:
      "Flight to Bagdogra (70km), train to New Jalpaiguri, toy train from Kurseong",
    estimatedCost: "₹8000-12000 for 4 days",
    weather: "Cold climate. Summer: 10-20°C, Winter: 2-7°C",
    safety:
      "Altitude sickness possible. Carry woolens. Toy train bookings in advance.",
  ...
  kolkata: {
    ...
    state: "West Bengal",
    overview:
      "City of Joy with colonial architecture, cultural heritage, and delicious Bengali cuisine.",
    bestTime: "October to March (15-30°C) - Pleasant weather",
    places: [
      "Victoria Memorial",
      "Howrah Bridge",
    ...
    hotels: [
      {
        name: "Budget Hotel, Sudder Street",
  ...
  mumbai: {
    ...
    state: "Maharashtra",
    overview:
      "Financial capital with Bollywood, beaches, historic sites, and vibrant street food.",
    bestTime: "November to February (20-30°C) - Pleasant weather",
    places: [
      "Gateway of India",
      "Marine Drive",
    ...
    hotels: [
      ...
      { name: "Mid-range Hotel", priceRange: "₹3000-5001", rating: 4.3 },
      { name: "Luxury Hotel", priceRange: "₹5001-8000", rating: 4.6 },
    ],
  ...
  ahmedabad: {
    ...
    state: "Gujarat",
    overview:
      "Manchester of India with textile heritage, historic monuments, and vegetarian cuisine.",
  ...
  guwahati: {
    ...
    state: "Assam",
    overview:
      "Gateway to Northeast India with ancient temples, tea gardens, and Brahmaputra River.",
    bestTime: "October to March (15-25°C) - Pleasant weather",
    places: [
      "Kamakhya Temple",
      "Umananda Island",
    ...
    reach:
      "Flights to Lokpriya Gopinath Airport, trains to Guwahati Station, buses",
    estimatedCost: "₹6000-9000 for 3 days",
    ...
    documents: [
      "ID Proof",
      "Hotel booking",
      "Inner Line Permit if traveling further",
    ],
  },
  ...
  amritsar: {
    ...
    state: "Punjab",
    overview:
      "Spiritual capital of Sikhism with the Golden Temple and rich Punjabi culture.",
    ...
    safety:
      "Respect temple rules (head cover, no shoes). Wagah Border ceremony timing varies.",
